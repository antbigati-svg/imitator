...
```python
from imitator import Browser, ClickType, Wait, WaitStrategy

with Browser(user_data_dir="cod") as browser:
...
```python
from imitator import Emunium, ClickType
...
```python
from imitator import PageParser
...
```python
from imitator import ClickType
...
```python
from imitator import ensure_chrome
